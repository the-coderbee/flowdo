...
class DashboardService:
    ...
    def _get_today_task_stats(self, user_id: int) -> Dict[str, Union[int, float]]:
    ...
    def _calculate_productivity_score(self, user_id: int) -> float:
        ...
        weighted_score = (
            task_score * 0.4 + focus_score * 0.3 + streak_score * 0.2 + goal_score * 0.1
        )

        return round(weighted_score, 1)

    def _get_week_task_stats(self, user_id: int) -> Dict[str, Union[int, float]]:
        ...
        completed = self.task_repo.count_completed_tasks_by_date_range(
    ...
    def _get_completion_streak(self, user_id: int) -> int:
        ...
        for i in range(30):  # Check last 30 days
            ...
            completed = self.task_repo.count_completed_tasks_by_date(
                user_id, check_date
            )
    ...
    def _get_recent_completed_tasks(
    ...
    def _get_weekly_goals_progress(self, user_id: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "task_progress": round(
                (week_stats["completed"] / 30 * 100) if week_stats["completed"] else 0,
                1,
            ),
